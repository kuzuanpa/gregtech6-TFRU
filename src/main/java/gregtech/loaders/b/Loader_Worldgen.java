...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
        ...
        //new WorldgenDungeonGT("tfc.structure.dungeon.large", T, 4000, 2, 5, 20, 20, 6, T, F, F, T, F, T, F, GEN_PFAA, GEN_TFC);
        new WorldgenDungeonGT("overworld.structure.dungeon.large", T, 1000, 3, 7, 20, 20, 6, T, F, F, T, T, T, T, T, GEN_OVERWORLD, GEN_GT);
...
//指南: 只需要在参数列表末尾加上GEN_XXX即可. 注意如果一个地方同时匹配多个GEN_XXX, 那么它会被生成多次.
		...
		new WorldgenFluidSpring(   "overworld.fluid.oil.extraheavy", T, BlocksGT.OilExtraHeavy  , 15, 300, 2, tInfiniteOil ? FL.Oil_ExtraHeavy  .make( 6000) : NF, GEN_OVERWORLD, GEN_GT, GEN_TFC);
		new WorldgenFluidSpring(   "overworld.fluid.oil.heavy"     , T, BlocksGT.OilHeavy       , 15, 300, 2, tInfiniteOil ? FL.Oil_Heavy       .make( 6000) : NF, GEN_OVERWORLD, GEN_GT, GEN_TFC);
		new WorldgenFluidSpring(   "overworld.fluid.oil.medium"    , T, BlocksGT.OilMedium      , 15, 300, 2, tInfiniteOil ? FL.Oil_Medium      .make( 6000) : NF, GEN_OVERWORLD, GEN_GT, GEN_TFC);
		new WorldgenFluidSpring(   "overworld.fluid.oil.light"     , T, BlocksGT.OilLight       , 15, 300, 2, tInfiniteOil ? FL.Oil_Light       .make( 6000) : NF, GEN_OVERWORLD, GEN_GT, GEN_TFC);
		new WorldgenFluidSpring(   "overworld.fluid.gas.natural"   , T, BlocksGT.GasNatural     , 15, 200, 1, tInfiniteGas ? FL.Gas_Natural     .make( 3000) : NF, GEN_OVERWORLD, GEN_GT, GEN_TFC);
		new WorldgenFluidSpring(   "overworld.fluid.water"         , T, BlocksGT.WaterGeothermal, 15, 400, 3,                FL.Water_Geothermal.make(   40)     , GEN_OVERWORLD, GEN_GT, GEN_TFC);
        ...
        new WorldgenFluidSpring(   "overworld.fluid.lava"          , T, Blocks.lava             ,  0, 200, 1,                FL.Lava            .make(  100)     , GEN_OVERWORLD, GEN_GT, GEN_TFC);
        new WorldgenFluidSpring(    "twilight.fluid.gas.natural"   , T, BlocksGT.GasNatural     , 15, 150, 1, tInfiniteGas ? FL.Gas_Natural     .make( 1000) : NF, GEN_TWILIGHT);
        new WorldgenFluidSpring(    "twilight.fluid.water"         , T, BlocksGT.WaterGeothermal, 15, 200, 3,                FL.Water_Geothermal.make(  250)     , GEN_TWILIGHT);
		...
		new WorldgenOresLarge("ore.large.peridot"     , T, T, 10,  40,  60, 3, 16, MT.OREMATS.Kyanite              , MT.MgCO3                       , MT.Peridot                     , MT.OREMATS.Glauconite , ORE_OVERWORLD, ORE_PLANETS);
