...
public class MultiItemTechnological extends MultiItemRandomWithCompat {
	...
	public void addItems() {
		...
		IL.Circuit_Plate_Empty             .set(addItem(30000, "Circuit Plate"                    , "Needs Circuit Wiring"                            , new OreDictItemData(ANY.SiO2, U, ANY.Wood, U), TC.stack(TC.FABRICO, 1)));
		...
		IL.Circuit_Plate_Copper            .set(addItem(30002, "Circuit Plate (Copper)"           , "Needs Circuit Parts"                             , new OreDictItemData(MT.Cu, U, ANY.SiO2, U, ANY.Wood, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PERMUTATIO, 1)));
		...
		IL.Circuit_Plate_Gold              .set(addItem(30004, "Circuit Plate (Gold)"             , "Needs Circuit Parts"                             , new OreDictItemData(MT.Au, U, MT.Bakelite, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.LUCRUM, 1), "oc:materialCircuitBoardPrinted"));
		...
		IL.Circuit_Plate_Platinum          .set(addItem(30006, "Circuit Plate (Platinum)"         , "Needs Circuit Parts"                             , new OreDictItemData(MT.Pt, U, MT.Bakelite, U, matList.EpoxyResin.mat, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.NEBRISUM, 1)));
		...
		IL.Circuit_Plate_Magic             .set(addItem(30012, "Circuit Plate (Magic)"            , "Needs Circuit Parts"                             , new OreDictItemData(ANY.SiO2, U, ANY.Wood, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		...
		IL.Circuit_Plate_Enderium          .set(addItem(30014, "Circuit Plate (Enderium)"         , "Needs Circuit Parts"                             , new OreDictItemData(MT.Enderium, U, ANY.SiO2, U, ANY.Wood, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.ALIENIS, 1)));
		...
		IL.Circuit_Plate_Signalum          .set(addItem(30016, "Circuit Plate (Signalum)"         , "Needs Circuit Parts"                             , new OreDictItemData(MT.Signalum, U, ANY.SiO2, U, ANY.Wood, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.POTENTIA, 1)));
