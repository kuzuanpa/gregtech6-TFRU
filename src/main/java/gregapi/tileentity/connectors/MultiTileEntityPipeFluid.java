...
import cn.kuzuanpa.ktfruaddon.tile.random.MultiTileEntityValve;
...
public class MultiTileEntityPipeFluid extends TileEntityBase10ConnectorRendered implements ITileEntityQuickObstructionCheck, IFluidHandler, ITileEntityGibbl, ITileEntityTemperature, ITileEntityProgress, ITileEntityServerTickPre, IMTE_GetCollisionBoundingBoxFromPool, IMTE_OnEntityCollidedWithBlock, IMultiTileEntity.IMTE_SyncDataByteArray, IWailaTile {
	...
	/**
	 * Utility to quickly add a whole set of Fluid Pipes.
	 * May use up to 20 IDs, even if it is just 8 right now!
	 */
	public static void addFluidPipes(int aID, int aCreativeTabID, long aStat, boolean aGasProof, boolean aAcidProof, boolean aPlasmaProof, boolean aMagicProof, boolean aContactDamage, boolean aFlammable, boolean aRecipe, boolean aBlocking, MultiTileEntityRegistry aRegistry, MultiTileEntityBlock aBlock, Class<? extends TileEntity> aClass, long aMaxTemperature, OreDictMaterial aMat) {
		...
		aRegistry.add("Fluid Valve ("+aMat.getLocal()+")"                      , "Fluid Pipes",  aID+ 7, aCreativeTabID, MultiTileEntityValve.class, aMat.mToolQuality, 16, aBlock , UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS,  aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid),NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature , NBT_TANK_CAPACITY, aStat* 12L), "hRS","PPP","PPP", 'S',OP.stickLong.dat(aMat), 'R', OP.plateCurved.dat(MT.Rubber), 'P', OP.plateCurved.dat(aMat));
