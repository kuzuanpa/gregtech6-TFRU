...
public class ANY {
	...
	protected static void init() {
		...
		MagicIron       .stealLooks(MT.Manasteel      ).steal(MT.Manasteel      ).setLocal("Magic Iron"         ).setAllToTheOutputOf(MT.Fe             ).put(SMITHABLE, MELTING, MAGICAL                            ).addReRegistrationToThis(MT.Manasteel, MT.Thaumium, MT.DarkThaumium, MT.SpectreIron, MT.FierySteel, MT.MeteoflameSteel);
