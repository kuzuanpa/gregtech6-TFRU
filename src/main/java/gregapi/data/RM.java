...
public class RM {
	...
	, HeatMixer                 = Mixer
	, BurnMixer                 = new RecipeMap                     (null, "gt.recipe.burnmixer"                    , "Burner Mixer"                    , null, 0, 1, RES_PATH_GUI+"machines/BurnMixer"                 ,/*IN-OUT-MIN-ITEM=*/ 6, 3, 0,/*IN-OUT-MIN-FLUID=*/ 6, 3, 0,/*MIN*/ 2,/*AMP=*/ 1, ""                    ,    1, ""      , T, T, T, T, F, T, T)
	...
	, Melter                    = new RecipeMap                     (null, "gt.recipe.melter"                       , "Melter"                          , null, 0, 1, RES_PATH_GUI+"machines/Melter"                    ,/*IN-OUT-MIN-ITEM=*/ 1, 1, 0,/*IN-OUT-MIN-FLUID=*/ 1, 1, 0,/*MIN*/ 1,/*AMP=*/ 1, ""                    ,    1, ""      , F, F, F, T, F, T, T)
